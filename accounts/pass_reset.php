...
<body oncontextmenu="return false;">
    ...
    <div class="row">
        ...
        <div style="width:300px; height:auto; margin:auto">
            ...
            <form name="form1" method="post" class="form-signin" id="form1" style="padding:20px;">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">Recuerde</div>
                            <div class="card-body">
                                <p class="card-text fz">Para recuperar su contraseña debe usar el correo que registró cuando actualizó sus datos en el sistema.</p>
                            </div>
                        </div>
                    </div>

                    <div class="col-md-12  mt-30">
                        <input type="text" class="form-control" id="__email" placeholder="Ingrese su email " autocomplete="off" required="">
                    ...
                    <div class="col-md-12">
                        <button id="lgn_btn" type="button" class="mt btn btn-success" onclick="resetPass()">Enviar</button>
                    </div>
